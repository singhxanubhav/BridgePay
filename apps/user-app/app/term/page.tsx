...
export const metadata: Metadata = {
  title: "Terms of Service | BridgePay",
  description: "Terms of Service for BridgePay digital wallet application",
};
      ...
      <div className="max-w-3xl mx-auto pt-20">
        ...
        <div className="space-y-6 text-gray-600">
          <section>
            ...
            <p>
              By accessing or using the BridgePay digital wallet application, you
          ...
          <section>
            ...
            <p>
              BridgePay provides a digital wallet service that allows users to
          ...
          <section>
            ...
            <p>
              To use BridgePay, you must create an account. You are responsible
          ...
          <section>
            ...
            <p>
              You agree not to use BridgePay for any unlawful purpose or in any
          ...
          <section>
            ...
            <p>
              BridgePay may charge fees for certain transactions or services.
          ...
          <section>
            ...
            <p>
              All content, features, and functionality of BridgePay are owned by
          ...
          <section>
            ...
            <p>
              BridgePay shall not be liable for any indirect, incidental, special,
