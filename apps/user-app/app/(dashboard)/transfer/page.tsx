...
export const metadata: Metadata = {
  title: 'Transfer | BridgePay',
  description: 'Transfer funds seamlessly with BridgePay digital wallet application',
}
    ...
    <div className="w-full mt-10 ">
      <div className="text-2xl  md:text-4xl pt-8 mb-8 font-bold text-violet-600 flex flex-col items-center">
        <h1 className="text-3xl md:text-4xl font-extrabold text-slate-800">
          <span className="text-blue-600">BridgePay </span>Transfer
        </h1>
